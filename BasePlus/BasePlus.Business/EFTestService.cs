...
{
    public static class EFTestService
    {
        ...
        public static List<TestResult> TestPostgreEFSelect()
        {
        ...
        public static List<TestResult> TestPostgreEFInsert()
        {
            List<TestResult> testResults = new List<TestResult>();
            DbHelper.ResetPostgre();
        ...
        public static List<TestResult> TestPostgreEFUpdate()
        {
            List<TestResult> testResults = new List<TestResult>();
            DbHelper.ResetPostgre();
        ...
        public static List<TestResult> TestMSSQLEFSelect()
        {
            List<TestResult> testResults = new List<TestResult>();
            DbHelper.ResetMssql();
        ...
        public static List<TestResult> TestMSSQLEFInsert()
        {
            List<TestResult> testResults = new List<TestResult>();
        ...
        public static List<TestResult> TestMSSQLEFUpdate()
        {
            List<TestResult> testResults = new List<TestResult>();
            DbHelper.ResetMssql();
